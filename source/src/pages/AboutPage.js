  ...
  return (
    <FadeIn>
      ...
      <div className='App-page'>
        ...
        <div style={{ margin: '10px' }}>
          <Link to="/projects">
            <button className='App-btn'>My Projects</button>
          </Link>
          <button className='github-button' onClick={() => window.open("https://github.com/ateebplayz", "_blank")}>
            <FontAwesomeIcon icon={['fab', 'github']} style={{ marginRight: '5px' }} />My Git
          </button>
        </div>
        </div>
      </div>
